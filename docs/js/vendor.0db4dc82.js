...
/* harmony export */ });
/* unused harmony exports TransitionGroup, VueElement, createSSRApp, defineCustomElement, defineSSRCustomElement, hydrate, initDirectivesForSSR, render, useCssModule, useCssVars, vModelCheckbox, vModelDynamic, vModelRadio, vModelSelect, vModelText, vShow, withKeys, withModifiers */
/* harmony import */ var _vue_shared__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2323);
...
;// CONCATENATED MODULE: ./node_modules/quasar/src/composables/private/use-size.js
...
/* harmony default export */ function use_size(props, sizes = useSizeDefaults) {
  // return sizeStyle
  return (0,reactivity_esm_bundler/* computed */.Fl)(() => props.size !== void 0 ? {
...
/* harmony default export */ const QIcon = ((0,runtime_core_esm_bundler/* defineComponent */.aZ)({
  name: 'QIcon',
  props: { ...useSizeProps,
    tag: {
      type: String,
  ...
  setup(props, {
    ...
    const sizeStyle = use_size(props);
    const classes = (0,reactivity_esm_bundler/* computed */.Fl)(() => 'q-icon' + (props.left === true ? ' on-left' : '') + (props.right === true ? ' on-right' : '') + (props.color !== void 0 ? ` text-${props.color}` : ''));
    const type = (0,reactivity_esm_bundler/* computed */.Fl)(() => {
      let cls;
      let icon = props.name;
      ...
      if (mRE.test(icon) === true) {
        ...
        return {
          ...
          nodes: def.split('&&').map(path => {
            ...
            return (0,runtime_core_esm_bundler.h)('path', {
              style,
              d,
              transform
            });
    ...
    return () => {
      ...
      if (type.value.none === true) {
        return (0,runtime_core_esm_bundler.h)(props.tag, data, (0,render/* hSlot */.KR)(slots.default));
      }

      if (type.value.img === true) {
        data.src = type.value.src;
        return (0,runtime_core_esm_bundler.h)('img', data);
      }

      if (type.value.svg === true) {
        data.viewBox = type.value.viewBox;
        return (0,runtime_core_esm_bundler.h)('svg', data, (0,render/* hMergeSlot */.vs)(slots.default, type.value.nodes));
      }

      if (type.value.svguse === true) {
        data.viewBox = type.value.viewBox;
        return (0,runtime_core_esm_bundler.h)('svg', data, (0,render/* hMergeSlot */.vs)(slots.default, [(0,runtime_core_esm_bundler.h)('use', {
          'xlink:href': type.value.src
        })]));
      }

      return (0,runtime_core_esm_bundler.h)(props.tag, data, (0,render/* hMergeSlot */.vs)(slots.default, [type.value.content]));
    };
  }
...
function useSpinner(props) {
  return {
    cSize: (0,reactivity_esm_bundler/* computed */.Fl)(() => props.size in useSizeDefaults ? `${useSizeDefaults[props.size]}px` : props.size),
...
const useBtnProps = { ...useSizeProps,
  ...useRouterLinkProps,
  type: {
    type: String,
    default: 'button'
...
/* harmony default export */ function use_btn(props) {
  const sizeStyle = use_size(props, defaultSizes);
...
/* harmony default export */ const QBtn = ((0,runtime_core_esm_bundler/* defineComponent */.aZ)({
  ...
  setup(props, {
    ...
    return () => {
      let inner = [];
      props.icon !== void 0 && inner.push((0,runtime_core_esm_bundler.h)(QIcon, {
        name: props.icon,
      ...
      if (props.iconRight !== void 0 && props.round === false) {
        inner.push((0,runtime_core_esm_bundler.h)(QIcon, {
...
/* harmony export */ });
/* unused harmony exports hUniqueSlot, hMergeSlotSafely */
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3673);
...
const autoInstalledPlugins = [plugins_Platform, body, Dark, Screen, src_history, lang, icon_set];
...
//# sourceMappingURL=vendor.0db4dc82.js.map